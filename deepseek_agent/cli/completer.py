...
COMMANDS: Dict[str, str] = {
    ...
    "/mode": "DeepSeek mode auto|instant|expert|vision · approval smart|always|never",
    "/think": "DeepSeek reasoning on|off",
    "/search": "DeepSeek web search on|off",
    "/login": "change DeepSeek account (email+password / token)",
